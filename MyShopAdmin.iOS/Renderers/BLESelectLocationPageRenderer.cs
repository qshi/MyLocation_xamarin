...
[assembly: ExportRenderer(typeof(SelectBLELLocationPage), typeof(BLESelectLocationPageRenderer))]

namespace MyShopAdmin.iOS
{
	public class BLESelectLocationPageRenderer: PageRenderer
	{
		public BLESelectLocationPageRenderer()
		{
		}
		private MapView mapView;
		List<Marker> markers;
		//double latti=0, longi=0;
		public SelectBLELLocationPage _selectPagePosition
		{
			get
			{
				return Element as SelectBLELLocationPage;
			}
		}
...
*/
			mapView.TappedMarker = (aMapView, aMarker) =>
			{
				...
				alert.Clicked += (object s, UIButtonEventArgs ev) =>
				{
					...
					if (ev.ButtonIndex != 0)
					{
						_selectPagePosition.Longitude = aMarker.Position.Longitude;
						_selectPagePosition.Latitude = aMarker.Position.Latitude;
